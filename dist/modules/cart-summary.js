...
function CartSummary(props) {
    ...
    return (React.createElement("section", {id: "cart-summary", className: "m-col-10-24 m-col-24-push-14"}, React.createElement("div", {className: "ms-row"}, React.createElement("div", {className: "m-col-22-24 m-col-24-offset-1"}, items, React.createElement("hr", null), props.controls, React.createElement("div", {className: "ms-row vc zero-margin subtotal"}, React.createElement("div", {className: "xs-col-6-24"}, "Subtotal"), React.createElement("div", {className: "xs-col-18-24 text-right"}, "$" + totals.subTotal.toFixed(2))), coupons, React.createElement("div", {className: "ms-row vc zero-margin tax-total"}, React.createElement("div", {className: "xs-col-6-24"}, "Tax"), React.createElement("div", {className: "xs-col-18-24 text-right"}, "$" + totals.taxTotal.toFixed(2))), React.createElement("div", {className: "ms-row vc zero-margin shipping-total"}, React.createElement("div", {className: "xs-col-6-24"}, "Shipping"), React.createElement("div", {className: "xs-col-18-24 text-right"}, totals.shippingTotal === 0 ? "Free" : "$35.00")), React.createElement("hr", null), React.createElement("div", {className: "ms-row vc zero-margin grand-total"}, React.createElement("div", {className: "xs-col-6-24"}, "Total"), React.createElement("div", {className: "xs-col-18-24 text-right"}, "USD ", React.createElement("strong", null, "$" + totals.ultimateTotal.toFixed(2))))))));
}
