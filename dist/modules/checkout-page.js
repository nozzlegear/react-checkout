...
var CheckoutPage = (function (_super) {
    ...
    CheckoutPage.prototype.generateHeader = function (forMobile) {
        ...
        return (React.createElement(Container, null, React.createElement("h1", {className: "page-title"}, this.props.siteName), React.createElement("ul", {id: "nav"}, React.createElement("li", null, React.createElement("a", {href: "/cart"}, "Cart")), React.createElement("li", {className: "chevron"}, React.createElement(FontAwesome, {name: "chevron-right", className: "fa-one-rem"})), React.createElement("li", {className: classes({ "active": currentPage === page.customerInformation })}, currentPage <= page.customerInformation ? "Customer Information" : React.createElement("a", {href: "#", onClick: navigate("customer")}, "Customer Information")), React.createElement("li", {className: "chevron"}, React.createElement(FontAwesome, {name: "chevron-right", className: "fa-one-rem"})), React.createElement("li", {className: classes({ "active": currentPage === page.shippingMethod })}, currentPage <= page.shippingMethod ? "Shipping Information" : React.createElement("a", {href: "#", onClick: navigate("shipping")}, "Shipping Information")), React.createElement("li", {className: "chevron"}, React.createElement(FontAwesome, {name: "chevron-right", className: "fa-one-rem"})), React.createElement("li", {className: classes({ "active": currentPage === page.paymentMethod })}, "Payment method"))));
    };
    CheckoutPage.prototype.generateCartSummary = function () {
        ...
        var controls = (React.createElement("div", null, React.createElement("div", {className: "ms-row vc zero-margin discount-form"}, React.createElement("div", {className: "xs-col-18-24 form-group", style: { "marginBottom": "0px" }}, React.createElement("input", {className: "win-textbox", placeholder: "Discount Code", value: code, onChange: this.updateState(function (s, v) { return s.summary.code = v; })})), React.createElement("div", {className: "xs-col-6-24 text-center"}, React.createElement("button", {className: "win-button", onClick: function (e) { return _this.applyDiscount(e); }}, loading ? React.createElement(FontAwesome, {key: lodash_1.uniqueId(), name: "spinner", spin: true}) : "Apply"))), error ? React.createElement("p", {className: "error red"}, error) : null, React.createElement("hr", null)));
    ...
    CheckoutPage.prototype.generateCustomerInformation = function () {
        ...
        return (React.createElement("section", {id: "customer-information"}, this.generateHeader(), React.createElement("form", null, React.createElement("div", {className: "form-group"}, React.createElement("label", {className: "control-label"}, "Customer information"), React.createElement("div", {className: "form-container ms-row"}, React.createElement("div", {className: "xs-col-24-24"}, React.createElement("input", {className: "win-textbox", type: "text", placeholder: "Email address", value: email, onChange: this.updateState(function (s, v) { return s.customer.email = v; })})))), React.createElement("div", {className: "form-group"}, React.createElement("label", {className: "control-label"}, "Shipping address"), this.generateAddressForm("shipping"))), error ? React.createElement("p", {className: "error red"}, error) : null, React.createElement("div", {className: "ms-row vc zero-margin"}, React.createElement("div", {className: "xs-col-8-24"}, React.createElement("a", {href: "/cart"}, React.createElement(FontAwesome, {name: "chevron-left", className: "marRight5 fa-one-rem"}), "Return to cart")), React.createElement("div", {className: "xs-col-16-24 text-right"}, React.createElement("button", {className: "win-button win-button-primary", onClick: function (e) { return _this.continueToShipping(e); }}, "Continue to shipping method")))));
    };
    CheckoutPage.prototype.generateShippingInformation = function () {
        ...
        return (React.createElement("section", {id: "shipping-information"}, this.generateHeader(), React.createElement("form", null, React.createElement("div", {id: "shipping-address", className: "form-group"}, React.createElement("label", {className: "control-label"}, "Shipping address"), React.createElement(address_line_1.AddressLine, {address: address}, React.createElement("a", {href: "#", onClick: back}, "Edit shipping address"))), React.createElement("div", {className: "form-group"}, React.createElement("label", {className: "control-label"}, "Shipping method"), React.createElement("div", {id: "shipping-method", className: "ms-row vc zero-margin"}, React.createElement("div", {className: "xs-col-2-24"}, React.createElement("input", {type: "radio", className: "win-radio", checked: true})), React.createElement("div", {className: "xs-col-12-24"}, address.CountryCode === "US" ? "Standard Shipping" : "International Shipping"), React.createElement("div", {className: "xs-col-9-24 text-right"}, "USD $" + this.props.totals.shippingTotal.toFixed(2))))), React.createElement("div", {className: "ms-row vc zero-margin"}, React.createElement("div", {className: "xs-col-12-24"}, React.createElement("a", {href: "#", onClick: back}, React.createElement(FontAwesome, {name: "chevron-left", className: "marRight5 fa-one-rem"}), "Return to customer information")), React.createElement("div", {className: "xs-col-12-24 text-right"}, React.createElement("button", {className: "win-button win-button-primary", onClick: function (e) { return _this.continueToPayment(e); }}, "Continue to payment method")))));
    };
    ...
    CheckoutPage.prototype.render = function () {
        ...
        return (React.createElement("main", {id: "checkout-page", className: "ms-grid"}, fontAwesome, React.createElement("div", {className: "ms-row"}, this.generateHeader(true), this.generateCartSummary(), React.createElement("section", {id: "panels", className: "m-col-14-24 m-col-24-pull-10"}, React.createElement("div", {className: "ms-row"}, React.createElement("div", {className: "m-col-22-24 m-col-24-offset-1"}, renderedPage)), React.createElement("div", {id: "copyright"}, React.createElement("p", null, "\u00A9 " + this.props.siteName + ", " + new Date().getUTCFullYear(), React.createElement("a", {href: "mailto:" + this.props.supportEmail, className: "pull-right"}, this.props.supportEmail)))))));
    };
    return CheckoutPage;
